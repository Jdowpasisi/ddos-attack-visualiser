...
MOCK_GEO_DATABASE: dict[str, dict] = {
    # United States
    "8.": {"country": "United States", "country_code": "US", "city": "Los Angeles", "lat": 34.0522, "lon": -118.2437},
    "12.": {"country": "United States", "country_code": "US", "city": "New York", "lat": 40.7128, "lon": -74.0060},
    "17.": {"country": "United States", "country_code": "US", "city": "Cupertino", "lat": 37.3230, "lon": -122.0322},
    "32.": {"country": "United States", "country_code": "US", "city": "Chicago", "lat": 41.8781, "lon": -87.6298},
    "44.": {"country": "United States", "country_code": "US", "city": "Seattle", "lat": 47.6062, "lon": -122.3321},
    
    # Europe
    "2.": {"country": "France", "country_code": "FR", "city": "Paris", "lat": 48.8566, "lon": 2.3522},
    "5.": {"country": "Germany", "country_code": "DE", "city": "Frankfurt", "lat": 50.1109, "lon": 8.6821},
    "31.": {"country": "Netherlands", "country_code": "NL", "city": "Amsterdam", "lat": 52.3676, "lon": 4.9041},
    "46.": {"country": "United Kingdom", "country_code": "GB", "city": "London", "lat": 51.5074, "lon": -0.1278},
    "77.": {"country": "Russia", "country_code": "RU", "city": "Moscow", "lat": 55.7558, "lon": 37.6173},
    "89.": {"country": "Russia", "country_code": "RU", "city": "St. Petersburg", "lat": 59.9311, "lon": 30.3609},
    
    # Asia
    "1.": {"country": "China", "country_code": "CN", "city": "Beijing", "lat": 39.9042, "lon": 116.4074},
    "14.": {"country": "Japan", "country_code": "JP", "city": "Tokyo", "lat": 35.6762, "lon": 139.6503},
    "27.": {"country": "China", "country_code": "CN", "city": "Shanghai", "lat": 31.2304, "lon": 121.4737},
    "36.": {"country": "China", "country_code": "CN", "city": "Shenzhen", "lat": 22.5431, "lon": 114.0579},
    "49.": {"country": "South Korea", "country_code": "KR", "city": "Seoul", "lat": 37.5665, "lon": 126.9780},
    "61.": {"country": "India", "country_code": "IN", "city": "Mumbai", "lat": 19.0760, "lon": 72.8777},
    "103.": {"country": "Singapore", "country_code": "SG", "city": "Singapore", "lat": 1.3521, "lon": 103.8198},
    "110.": {"country": "Taiwan", "country_code": "TW", "city": "Taipei", "lat": 25.0330, "lon": 121.5654},
    "118.": {"country": "Indonesia", "country_code": "ID", "city": "Jakarta", "lat": -6.2088, "lon": 106.8456},
    
    # South America
    "138.": {"country": "Brazil", "country_code": "BR", "city": "São Paulo", "lat": -23.5505, "lon": -46.6333},
    "152.": {"country": "Argentina", "country_code": "AR", "city": "Buenos Aires", "lat": -34.6037, "lon": -58.3816},
    "179.": {"country": "Brazil", "country_code": "BR", "city": "Rio de Janeiro", "lat": -22.9068, "lon": -43.1729},
    
    # Africa
    "41.": {"country": "South Africa", "country_code": "ZA", "city": "Johannesburg", "lat": -26.2041, "lon": 28.0473},
    "102.": {"country": "Nigeria", "country_code": "NG", "city": "Lagos", "lat": 6.5244, "lon": 3.3792},
    "196.": {"country": "Egypt", "country_code": "EG", "city": "Cairo", "lat": 30.0444, "lon": 31.2357},
    
    # Oceania
    "101.": {"country": "Australia", "country_code": "AU", "city": "Sydney", "lat": -33.8688, "lon": 151.2093},
    "203.": {"country": "Australia", "country_code": "AU", "city": "Melbourne", "lat": -37.8136, "lon": 144.9631},
}

# Default fallback locations when IP prefix isn't found
FALLBACK_LOCATIONS = [
    {"country": "United States", "country_code": "US", "city": "Ashburn", "lat": 39.0438, "lon": -77.4874},
...
class LRUCache:
    ...
    def get(self, key: str) -> Optional[GeoLocation]:
...
class GeoService:
    ...
    async def _get_http_client(self):
        ...
        if httpx is None:
            raise ImportError("httpx is required for ip-api backend. Install with: pip install httpx")
        if self._http_client is None or self._http_client.is_closed:
            self._http_client = httpx.AsyncClient(
                timeout=httpx.Timeout(10.0),
                headers={"User-Agent": "DDoS-Visualizer/1.0"}
            )
    ...
    async def _lookup_from_database(self, ip: str) -> Optional[GeoLocation]:
        """
        ...
        try:
            ...
            cutoff = datetime.now(timezone.utc) - timedelta(hours=self.DB_LOOKUP_MAX_AGE_HOURS)
            
            async with async_session_maker() as session:
                # Look for this IP as source or target in recent events
                stmt = select(AttackEvent).where(
                    AttackEvent.timestamp >= cutoff,
                    or_(
                        AttackEvent.source_ip == ip,
                        AttackEvent.target_ip == ip
                    )
                ).order_by(AttackEvent.timestamp.desc()).limit(1)
    ...
    async def _resolve_ip_api(self, ip: str) -> Optional[GeoLocation]:
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--backend", choices=["mock", "ip-api"], default="mock", help="Backend to use")
        ...
        try:
            ...
            if args.test_batch:
                ...
                for ip in test_ips:
                    ...
                    print(f"  {ip} -> {location.country} ({location.lat:.2f}, {location.lon:.2f}) [{location.source}]")
